...
setwd("C:/Users/ulise/Documents/GitHub/Modelo-base-dinamica-de-opinion/experimentos/influencia negativa/experimento2")
library(tidyverse)

experimento2_table <- read.csv('experimento-2-negativa-table.csv', skip = 6)
...
# Para este experimento se evalúa el efecto del número de agentes interactuando
...
ggplot(error_experimento2, aes(x=agents_per_tick, y = RMSE)) +
  ...
  labs(
    title = "Error de acuerdo al número de agentes
    interactuando por tick",
    x = "Agents per tick",

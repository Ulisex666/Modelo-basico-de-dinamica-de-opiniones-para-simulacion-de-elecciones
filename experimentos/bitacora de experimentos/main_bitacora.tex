...
\section{Materiales y métodos}
	El protocolo ODD del modelo base se encuentra anexado al final del presente documento, adaptado para su uso en el caso de estudio. Para iniciar la experimentación con el caso más sencillo, se tomaron en cuenta únicamente a los dos candidatos principales en la elección estudiada. De esta forma, se ajustaron los porcentajes de las encuestas de opinión y los resultados de la elección. 
...
\begin{tabular}{|c|c|}
	...
	\hline
	\textit{confidence-threshold} & 0.0 \\
	\hline
	percent-option-B & 39 \\
	\hline

...
setwd("C:/Users/ulise/Documents/GitHub/Modelo-base-dinamica-de-opinion/experimentos/confianza acotada/experimento3")
library(tidyverse)

experimento3_table <- read.csv('experimento-3-BC-table.csv', skip = 6)
...
error_experimento3 <- experimento3_avg %>%
  ...
  # Se agrupa el error en base al parámetro confidence threshold
...
experimento2_mejor <- experimento3_table %>%
